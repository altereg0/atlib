...
public:
  ...
  static uint16_t read(uint8_t pin) {
    ...
    switch (pin) {
    case _ADC7: ADMUX |= _BV(MUX2) | _BV(MUX1) | _BV(MUX0);
      break;    // ADC7
    case _ADC6: ADMUX |= _BV(MUX2) | _BV(MUX1);
      break;        // ADC6
    case _ADC5: ADMUX |= _BV(MUX2) | _BV(MUX0);
      break;        // ADC5
    case _ADC4: ADMUX |= _BV(MUX2);
      break;                // ADC4
    case _ADC3: ADMUX |= _BV(MUX1) | _BV(MUX0);
      break;        // ADC3
    case _ADC2: ADMUX |= _BV(MUX1);
      break;                // ADC2
    case _ADC1: ADMUX |= _BV(MUX0);
      break;                // ADC1
    case _ADC0:                            // ADC0
    default: break;
    }
